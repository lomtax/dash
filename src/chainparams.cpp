...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 100000000;//951;
        ...
        consensus.DIP0003Height = 100000000;//1028160;
        consensus.DIP0003EnforcementHeight = 100000000;//1047200;
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.digitalcoindot.io", true);
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("digitalcoinevo.org",  "devnet-seed.digitalcoinevo.org"));
