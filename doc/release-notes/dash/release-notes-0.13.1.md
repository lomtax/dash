Digitalcoin Core version 0.13.1.0
==========================
...
- [`070ad103f`](https://github.com/dashpay/dash/commit/070ad103f) Wait for script checks to finish before messing with txes in Digitalcoin-specific way (#2652)
