...
Below are some notes on how to build Digitalcoin Core for Windows.
...
way. This will install to `c:\workspace\digitalcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/digitalcoin
