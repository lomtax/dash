// Copyright (c) 2018-2019 The Digitalcoin Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DGC_CRYPTO_BLS_BATCHVERIFIER_H
#define DGC_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //DGC_CRYPTO_BLS_BATCHVERIFIER_H
