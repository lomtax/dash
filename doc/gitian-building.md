...
in the Digitalcoin Core repository under 'Fetch and create inputs' to install sources which require
...
BTCPATH=/some/root/path/digitalcoin
SIGPATH=/some/root/path/digitalcoin-detached-sigs
