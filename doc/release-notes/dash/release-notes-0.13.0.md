...
- [`0692de1c5`](https://github.com/dashpay/dash/commit/0692de1c5) Fix prepare_masternodes/create_masternodes in DigitalcoinTestFramework (#2382)
...
- [`1681d6366`](https://github.com/dashpay/dash/commit/1681d6366) Replace Digitalcoin-specific threads with Digitalcoin-specific scheduled tasks (#2043)
...
- [`e23339d6f`](https://github.com/dashpay/dash/commit/e23339d6f) use nullptr in Digitalcoin-specific code (#2166)
...
- [`8ee9333bc`](https://github.com/dashpay/dash/commit/8ee9333bc) remove boost dependency from Digitalcoin-specific code (#2072)
