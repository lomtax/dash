...
official/supported Docker Images found at https://hub.docker.com/r/digitalcoinpay/digitalcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/digitalcoinpay/digitalcoind-develop/ when changing the above text**